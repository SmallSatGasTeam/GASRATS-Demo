...
class FlightLogic : public FlightLogicComponentBase {
  public:
    // ----------------------------------------------------------------------
    ...
    FlightLogic(const char* const compName  //!< The component name
    );
  ...
  PRIVATE:
    ...
    U32 dataRequest_handler(NATIVE_INT_TYPE portNum,  //!< The port number
                            U32 value) override;
    ...
    void startup_handler(NATIVE_INT_TYPE portNum,  //!< The port number
    ...
    GASRATS::beacon beaconState_handler(NATIVE_INT_TYPE portNum,  //!< The port number
                                        const GASRATS::beacon& value) override;
    ...
    void pingIn_handler(NATIVE_INT_TYPE portNum,  //!< The port number
  ...
  PRIVATE:
    ...
    void takePic_cmdHandler(FwOpcodeType opCode,  //!< The opcode
    ...
    void resetFlags_cmdHandler(FwOpcodeType opCode,  //!< The opcode
                               U32 cmdSeq            //!< The command sequence number
                               ) override;
