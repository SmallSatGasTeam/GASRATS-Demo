...
namespace Components {
    ...
    takePic_handler(NATIVE_INT_TYPE portNum)
  {
    ...
    #ifndef VIRTUAL
      std::string stillautocommand = "libcamera-still -r -e png -o /home/gas/photos/fprimeTest" + std::to_string(this->picCount) + ".jpg --autofocus-on-capture --hdr --awb auto --denoise auto";
