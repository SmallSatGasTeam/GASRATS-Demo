// ======================================================================
// \title  LinuxinterruptTimerDeploymentTopology.cpp
// \brief cpp file containing the topology instantiation code
//
// ======================================================================
// Provides access to autocoded functions
#include <LinuxinterruptTimerDeployment/Top/LinuxinterruptTimerDeploymentTopologyAc.hpp>
#include <LinuxinterruptTimerDeployment/Top/LinuxinterruptTimerDeploymentPacketsAc.hpp>
...
void configureTopology() {
    ...
    // tlmSend.setPacketList(LinuxinterruptTimerDeploymentPacketsPkts, LinuxinterruptTimerDeploymentPacketsIgnore, 1);
...
// Public functions for use in main program are namespaced with deployment name LinuxinterruptTimerDeployment
...
void startSimulatedCycle(U32 milliseconds) {
    ...
    // Main loop
    while (cycling) {
        LinuxinterruptTimerDeployment::blockDrv.callIsr();
