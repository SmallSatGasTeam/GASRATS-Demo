// ======================================================================
// \title  LinuxinterruptTimerDeploymentTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef LINUXINTERRUPTTIMERDEPLOYMENT_LINUXINTERRUPTTIMERDEPLOYMENTTOPOLOGY_HPP
#define LINUXINTERRUPTTIMERDEPLOYMENT_LINUXINTERRUPTTIMERDEPLOYMENTTOPOLOGY_HPP
// Included for access to LinuxinterruptTimerDeployment::TopologyState and LinuxinterruptTimerDeployment::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <LinuxinterruptTimerDeployment/Top/LinuxinterruptTimerDeploymentTopologyDefs.hpp>

// Remove unnecessary LinuxinterruptTimerDeployment:: qualifications
using namespace LinuxinterruptTimerDeployment;
namespace LinuxinterruptTimerDeployment {
/**
 ...
 * LinuxinterruptTimerDeployment::TopologyState see: LinuxinterruptTimerDeploymentTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type LinuxinterruptTimerDeployment::TopologyState see: LinuxinterruptTimerDeploymentTopologyDefs.hpp.
 *
