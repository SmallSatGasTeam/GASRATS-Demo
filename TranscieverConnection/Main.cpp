...
#include <TranscieverConnection/Top/TranscieverConnectionTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
static void signalHandler(int signum) {
    TranscieverConnection::stopSimulatedCycle();
}
...
int main(int argc, char* argv[]) {
    ...
    TranscieverConnection::TopologyState inputs;
    ...
    TranscieverConnection::setupTopology(inputs);
    TranscieverConnection::startSimulatedCycle(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    TranscieverConnection::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
