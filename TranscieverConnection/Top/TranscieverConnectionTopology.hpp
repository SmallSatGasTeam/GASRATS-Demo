// ======================================================================
// \title  TranscieverConnectionTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef TRANSCIEVERCONNECTION_TRANSCIEVERCONNECTIONTOPOLOGY_HPP
#define TRANSCIEVERCONNECTION_TRANSCIEVERCONNECTIONTOPOLOGY_HPP
// Included for access to TranscieverConnection::TopologyState and TranscieverConnection::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <TranscieverConnection/Top/TranscieverConnectionTopologyDefs.hpp>

// Remove unnecessary TranscieverConnection:: qualifications
 ...
 * TranscieverConnection::TopologyState see: TranscieverConnectionTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type TranscieverConnection::TopologyState see: TranscieverConnectionTopologyDefs.hpp.
 *
