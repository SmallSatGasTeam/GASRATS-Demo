...
#include <TransceiverI2CTest/Top/TransceiverI2CTestTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
static void signalHandler(int signum) {
    TransceiverI2CTest::stopSimulatedCycle();
}
...
int main(int argc, char* argv[]) {
    ...
    TransceiverI2CTest::TopologyState inputs;
    ...
    TransceiverI2CTest::setupTopology(inputs);
    TransceiverI2CTest::startSimulatedCycle(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    TransceiverI2CTest::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
