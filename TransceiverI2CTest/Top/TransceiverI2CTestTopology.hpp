// ======================================================================
// \title  TransceiverI2CTestTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef TRANSCEIVERI2CTEST_TRANSCEIVERI2CTESTTOPOLOGY_HPP
#define TRANSCEIVERI2CTEST_TRANSCEIVERI2CTESTTOPOLOGY_HPP
// Included for access to TransceiverI2CTest::TopologyState and TransceiverI2CTest::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <TransceiverI2CTest/Top/TransceiverI2CTestTopologyDefs.hpp>

// Remove unnecessary TransceiverI2CTest:: qualifications
 ...
 * TransceiverI2CTest::TopologyState see: TransceiverI2CTestTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type TransceiverI2CTest::TopologyState see: TransceiverI2CTestTopologyDefs.hpp.
 *
