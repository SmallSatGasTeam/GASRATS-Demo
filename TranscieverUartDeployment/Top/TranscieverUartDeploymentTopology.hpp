// ======================================================================
// \title  TranscieverUartDeploymentTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef TRANSCIEVERUARTDEPLOYMENT_TRANSCIEVERUARTDEPLOYMENTTOPOLOGY_HPP
#define TRANSCIEVERUARTDEPLOYMENT_TRANSCIEVERUARTDEPLOYMENTTOPOLOGY_HPP
// Included for access to TranscieverUartDeployment::TopologyState and TranscieverUartDeployment::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <TranscieverUartDeployment/Top/TranscieverUartDeploymentTopologyDefs.hpp>

// Remove unnecessary TranscieverUartDeployment:: qualifications
 ...
 * TranscieverUartDeployment::TopologyState see: TranscieverUartDeploymentTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type TranscieverUartDeployment::TopologyState see: TranscieverUartDeploymentTopologyDefs.hpp.
 *
