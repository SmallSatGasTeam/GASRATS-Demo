// ======================================================================
// \title  TranscieverUartDeploymentTopology.cpp
// \brief cpp file containing the topology instantiation code
//
// ======================================================================
// Provides access to autocoded functions
#include <TranscieverUartDeployment/Top/TranscieverUartDeploymentTopologyAc.hpp>
// Note: Uncomment when using Svc:TlmPacketizer
//#include <TranscieverUartDeployment/Top/TranscieverUartDeploymentPacketsAc.hpp>

// Necessary project-specified types
#include <Fw/Types/MallocAllocator.hpp>
#include <Svc/FramingProtocol/EndurosatProtocol.hpp> // using our own protocol!!

// Used for 1Hz synthetic cycling
#include <Os/Mutex.hpp>

// Allows easy reference to objects in FPP/autocoder required namespaces
using namespace TranscieverUartDeployment;
...
Svc::Health::PingEntry pingEntries[] = {
    {PingEntries::TranscieverUartDeployment_blockDrv::WARN, PingEntries::TranscieverUartDeployment_blockDrv::FATAL, "blockDrv"},
    {PingEntries::TranscieverUartDeployment_tlmSend::WARN, PingEntries::TranscieverUartDeployment_tlmSend::FATAL, "chanTlm"},
    {PingEntries::TranscieverUartDeployment_cmdDisp::WARN, PingEntries::TranscieverUartDeployment_cmdDisp::FATAL, "cmdDisp"},
    {PingEntries::TranscieverUartDeployment_cmdSeq::WARN, PingEntries::TranscieverUartDeployment_cmdSeq::FATAL, "cmdSeq"},
    {PingEntries::TranscieverUartDeployment_eventLogger::WARN, PingEntries::TranscieverUartDeployment_eventLogger::FATAL, "eventLogger"},
    {PingEntries::TranscieverUartDeployment_fileDownlink::WARN, PingEntries::TranscieverUartDeployment_fileDownlink::FATAL, "fileDownlink"},
    {PingEntries::TranscieverUartDeployment_fileManager::WARN, PingEntries::TranscieverUartDeployment_fileManager::FATAL, "fileManager"},
    {PingEntries::TranscieverUartDeployment_fileUplink::WARN, PingEntries::TranscieverUartDeployment_fileUplink::FATAL, "fileUplink"},
    {PingEntries::TranscieverUartDeployment_prmDb::WARN, PingEntries::TranscieverUartDeployment_prmDb::FATAL, "prmDb"},
    {PingEntries::TranscieverUartDeployment_rateGroup1::WARN, PingEntries::TranscieverUartDeployment_rateGroup1::FATAL, "rateGroup1"},
    {PingEntries::TranscieverUartDeployment_rateGroup2::WARN, PingEntries::TranscieverUartDeployment_rateGroup2::FATAL, "rateGroup2"},
    {PingEntries::TranscieverUartDeployment_rateGroup3::WARN, PingEntries::TranscieverUartDeployment_rateGroup3::FATAL, "rateGroup3"},
};
...
void configureTopology() {
    ...
    // Note: Uncomment when using Svc:TlmPacketizer
    // tlmSend.setPacketList(TranscieverUartDeploymentPacketsPkts, TranscieverUartDeploymentPacketsIgnore, 1);
...
// Public functions for use in main program are namespaced with deployment name TranscieverUartDeployment
namespace TranscieverUartDeployment {
...
void startSimulatedCycle(Fw::TimeInterval interval) {
    ...
    // Main loop
    while (cycling) {
        TranscieverUartDeployment::blockDrv.callIsr();
