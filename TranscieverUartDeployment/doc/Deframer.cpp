...
void Deframer ::setUseFPrimeProtocol(bool useFPrimeProtocol) {
    this->useFPrimeProtocol = useFPrimeProtocol;
}

bool Deframer::getUseFPrimeProtocol() {
    return this->useFPrimeProtocol;
}
...
void Deframer ::setup(DeframingProtocol& protocol) {
    printf("[DEBUG] Deframer::setup() called with protocol: %p\n", &protocol);
...
void Deframer ::route(Fw::Buffer& packetBuffer) {
    printf("[DEBUG] Deframer::route() called\n");
    ...
    if (status == Fw::FW_SERIALIZE_OK) {
        ...
        switch (packetType) {
            ...
            case Fw::ComPacket::FW_PACKET_COMMAND: {
                printf("[DEBUG] Deframer::route() processing FW_PACKET_COMMAND\n");
            ...
            case Fw::ComPacket::FW_PACKET_FILE: {
                printf("[DEBUG] Deframer::route() processing FW_PACKET_FILE\n");
