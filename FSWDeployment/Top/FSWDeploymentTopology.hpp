// ======================================================================
// \title  FSWDeploymentTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef FSWDEPLOYMENT_FSWDEPLOYMENTTOPOLOGY_HPP
#define FSWDEPLOYMENT_FSWDEPLOYMENTTOPOLOGY_HPP
// Included for access to FSWDeployment::TopologyState and FSWDeployment::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <FSWDeployment/Top/FSWDeploymentTopologyDefs.hpp>

// Remove unnecessary FSWDeployment:: qualifications
 ...
 * FSWDeployment::TopologyState see: FSWDeploymentTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type FSWDeployment::TopologyState see: FSWDeploymentTopologyDefs.hpp.
 *
