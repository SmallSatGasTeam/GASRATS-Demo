...
#include <FSWDeployment/Top/FSWDeploymentTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
static void signalHandler(int signum) {
    FSWDeployment::stopSimulatedCycle();
}
...
int main(int argc, char* argv[]) {
    ...
    FSWDeployment::TopologyState inputs;
    ...
    FSWDeployment::setupTopology(inputs);
    FSWDeployment::startSimulatedCycle(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    FSWDeployment::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
