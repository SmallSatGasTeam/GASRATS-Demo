// ======================================================================
// \title  InterruptTestTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef INTERRUPTTEST_INTERRUPTTESTTOPOLOGY_HPP
#define INTERRUPTTEST_INTERRUPTTESTTOPOLOGY_HPP
// Included for access to InterruptTest::TopologyState and InterruptTest::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <InterruptTest/Top/InterruptTestTopologyDefs.hpp>

// Remove unnecessary InterruptTest:: qualifications
 ...
 * InterruptTest::TopologyState see: InterruptTestTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type InterruptTest::TopologyState see: InterruptTestTopologyDefs.hpp.
 *
