// ======================================================================
// \title  InterruptTestTopologyDefs.hpp
// \brief required header file containing the required definitions for the topology autocoder
//
// ======================================================================
#ifndef INTERRUPTTEST_INTERRUPTTESTTOPOLOGYDEFS_HPP
#define INTERRUPTTEST_INTERRUPTTESTTOPOLOGYDEFS_HPP

#include "Drv/BlockDriver/BlockDriver.hpp"
#include "Fw/Types/MallocAllocator.hpp"
#include "InterruptTest/Top/FppConstantsAc.hpp"
 ...
 *
 * The topology autocoder requires an object that carries state with the name `InterruptTest::TopologyState`. Only the type
